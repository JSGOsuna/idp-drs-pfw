  ...
  return (
    <div className="shadow space-y-1 p-4 bg-white border-t border-gray-200">
      <div className="space-y-4">
        ...
        {/* 🟨 Campo de comentario debajo del subtotal */}
        {/* <div className="mt-3">
          <label
          ...
          <textarea
            ...
            className="w-full border border-gray-300 rounded-lg p-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-amber-400"
          ></textarea>
        </div> */}
      </div>
    </div>
